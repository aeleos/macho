...
void _StateBase::_shutdown() { _myStateInfo.machine().shutdown(); }
...
_StateInfo::_StateInfo(_MachineBase &machine, _StateInfo *parent)
    : myMachine(machine), myInstance(0), myHistory(0), myParent(parent),
...
_MachineBase::_MachineBase()
    : myCurrentState(0), myPendingState(0), myPendingBox(0),
      myPendingHistory(false), myPendingEvent(0) {}
